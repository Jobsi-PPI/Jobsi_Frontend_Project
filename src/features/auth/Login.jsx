...
<div className="flex min-h-screen w-full">
    ...
    <div className="absolute bottom-6 right-0 w-1/2 h-[10px] bg-white z-40"></div>
        ...
        <div className="w-full max-w-3xl bg-[#fbfdff] py-15 px-45 rounded-[100px] shadow-md transform translate-x-[-15%] mt-16 z-0">
            <div className="relative flex justify-center">
                {/* Círculo amarillo */}
                <span className="absolute -top-35 w-35 h-35 bg-[#fbbf24] rounded-full left-1/15 flex items-center justify-center">
                    <img
    ...
    <div className="flex items-center justify-center min-h-screen w-1/2 bg-white overflow-hidden relative"> 
        ...
        <div className="texto-side-white absolute bottom-[25%] left-[10%] space-y-4 bg">
            <h2 className=" text-4xl font-bold text-[#1e293b]">Hecho para universitarios</h2>
            <h3 className="font-light text-[22px] text-black">Jobsi te ayuda a resolver tus problemas y 
                            <br/>necesidades universitarias en cuestión de pocos clics  </h3>
            <img
                src="/src/assets/jobsi-mascota-jobito_render.png"
                alt="Logo Jobsi"
                className="absolute left-[15%] bottom-[-115%] -translate-x-1/2 -translate-y-1/2 w-[140px] h-[120px] object-cover"
            />
            <img
                src="/src/assets/jobsi_graduation_logo.png"
                alt="Logo Jobsi"
                className="absolute left-[15%] bottom-[200%] w-[300px] h-[220px] object-cover"
            />
            <img
                src="/src/assets/jobsi-mascota-jobito_render.png"
                alt="Logo Jobsi"
                className="absolute left-[95%] bottom-[90%] -translate-x-1/2 -translate-y-1/2 w-[140px] h-[120px] object-cover"
            />
